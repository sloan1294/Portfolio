        ...
        <div class="w-[460px] h-[775px] rounded-lg overflow-hidden shadow-2xl shadow-[#49c5b6]">
          ...
          <div class="px-2 py-6 max-[550px]:px-10">
            ...
            <p className="text-white text-center text-base mb-1">
              (No Template) TracMate is a budgeting app that allows you to create an account
        ...
        <div class="w-[460px] h-[775px] rounded-lg overflow-hidden shadow-2xl shadow-[#49c5b6]">
          ...
          <div class="px-2 py-6 max-[550px]:px-10">
            ...
            <p className="text-white text-center text-base m-6">
              (No Template) This is a weather app that will tell you the current temputure in
              the city you search. Using the Gps image on the left hand side of
              the input area will allow you to get your current location.
            </p>
            <p className="text-white text-center text-base mb-1 pt-2">
              <b className="text-[#49c5b6]">Challanges: </b> Overall this
              project was not too difficult. Connecting to the open weather Api
              was stright forward, and retriving that data was explained well in
              the docs. Calling the second Api and returning the correct
              data(kept returning wrong location) was quite a bit harder!
            </p>
          </div>
          <div className="flex justify-center">
