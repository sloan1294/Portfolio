...
export default function About() {
  return (
    <section id="about" className="pt-4">
      <div className="border-double border-8 border-[#49c5b6] mt-[5%] m-10 max-[550px]:w-[82%]">
        <div className="container mx-auto flex px-20 lg:py-28 sm:py-20 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <p className="mb-8 leading-relaxed text-[#49c5b6] text-2xl">
          ...
          <div className="flex justify-center rotate-[-15deg] lg:max-w-lg lg:w-full md:w-1/2 w-[5/6] ">
            <img
              className="max-[550px]:mt-[-45px] max-[550px]:mb-4 h-110 rounded-full border-solid border-2 border-[#49c5b6]"
              alt="hero"
              src={Port}
            />
          </div>
